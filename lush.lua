...
function lush.update() 
	-- Benchmark this and see how many elements are removed each update. If the number is big enough, consider setting the elements to remove to nil
	-- and shifting the array by myself: http://stackoverflow.com/questions/12394841/safely-remove-items-from-an-array-table-while-iterating
	--local useNow = [[
